  ...
  <header id="header" class="header-transparent">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="/resources/index.html" class="scrollto">Avilon</a></h1>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="/resources/index.html">Home</a></li>
  ...
  <section id="intro">
    ...
    <div class="product-screens">
      ...
      <div class="product-screen-1 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.6s">
        <img src="/resources/assets/img/product-screen-1.png" alt="">
      </div>

      <div class="product-screen-2 wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.6s">
        <img src="/resources/assets/img/product-screen-2.png" alt="">
      </div>

      <div class="product-screen-3 wow fadeInUp" data-wow-duration="0.6s">
        <img src="/resources/assets/img/product-screen-3.png" alt="">
      </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="/resources/assets/img/gallery/gallery-1.jpg" data-gall="portfolioGallery" class="venobox">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="/resources/assets/img/gallery/gallery-2.jpg" data-gall="portfolioGallery" class="venobox">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="/resources/assets/img/gallery/gallery-3.jpg" data-gall="portfolioGallery" class="venobox">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="/resources/assets/img/gallery/gallery-4.jpg" data-gall="portfolioGallery" class="venobox">
                <img src="/resources/assets/img/gallery/gallery-4.jpg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="/resources/assets/img/gallery/gallery-5.jpg" data-gall="portfolioGallery" class="venobox">
                <img src="/resources/assets/img/gallery/gallery-5.jpg" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item wow fadeInUp">
              <a href="/resources/assets/img/gallery/gallery-6.jpg" data-gall="portfolioGallery" class="venobox">
                <img src="/resources/assets/img/gallery/gallery-6.jpg" alt="">
              </a>
            </div>
          </div>
